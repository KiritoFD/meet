...
from pose.binding import BindingConfig
from pose.pose_binding import PoseBinding  # Added missing import
...
from pose.types import PoseData  # Added missing import
    ...
    def set_reference(self, frame: np.ndarray, pose_data) -> bool:
        try:
            ...
            if self.nvidia_model.is_initialized:
                ...
                # 自动启用NVIDIA模型（如果初始化成功）
                self.use_nvidia_model = True
